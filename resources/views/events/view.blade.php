...
<div class="min-w-screen h-screen overflow-y-scroll flex items-center justify-center px-5 pb-10 mt-24">
...
@if ((Auth::user()->hasRole('Organisation')) && (Auth::user()->hasRole('Inneed')))
